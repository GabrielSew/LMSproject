...
CREATE TABLE `loan` (
  ...
  CONSTRAINT `loan_ibfk_1` FOREIGN KEY (`Library_Item_ID`) REFERENCES `library_item` (`ItemID`),
  CONSTRAINT `loan_ibfk_2` FOREIGN KEY (`Client_Email`) REFERENCES `client` (`Email`)
...
-- Dump completed on 2025-04-20 16:32:26
